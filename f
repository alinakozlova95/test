...
<p>Вопрос 11</p>
<div class="alert alert-secondary" role="alert">
<p><span id="v_11"></span> <input class="form-control" type="text" id="z_11"></p>
</div>
</div>
<div id="vopros12" style="display:none;">
<p>Вопрос 12</p>
<div class="alert alert-secondary" role="alert">
<p><span id="v_12"></span> <input class="form-control" type="text" id="z_12"></p>
</div>
</div>
<div id="vopros13" style="display:none;">
<p>Вопрос 13</p>
<div class="alert alert-secondary" role="alert">
<p><span id="v_13"></span> <input class="form-control" type="text" id="z_13"></p>
</div>
</div>
<div id="vopros14" style="display:none;">
<p>Вопрос 14</p>
<div class="alert alert-secondary" role="alert">
<p><span id="v_14"></span> <input class="form-control" type="text" id="z_14"></p>
</div>
</div>
<div id="vopros15" style="display:none;">
<p>Вопрос 15</p>
<div class="alert alert-secondary" role="alert">
<p><span id="v_15"></span> <input class="form-control" type="text" id="z_15"></p>
</div>
</div>
<button id="kn_sl" class="btn btn-lg btn-primary btn-block" style="margin-left:auto;margin-right:auto;width:250px;" onclick="sled_vopr();">Следующий вопрос</button>
...
if(otv_uch_15 == voprosi[14][1]){
    ...
    otveti += "<tr class='table-danger'><td>15</td><td>"+voprosi[14][0]+"</td><td>Вы ответили не верно. Ваш ответ: "+otv_ucgenika_15+"</td></tr></table><p class='small'><a href='https://vk.com/elearningru'>Группа ВКонтакте</a>, <a href='https://ok.ru/elearning'>Группа Одноклассники</a>, <a href='https://www.facebook.com/groups/elearning.ru/'>Группа Facebook.</a></p>";
}
vsego_zadach = 15;
